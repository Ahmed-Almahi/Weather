      ...
      <div className="w-full max-w-md bg-white/80 rounded-2xl shadow-xl p-8 backdrop-blur-md">
        <div className="flex flex-col items-center mb-6">
          <Image
            src={Logo}
            alt="Weather"
            className="h-30 w-auto mb-2 drop-shadow-lg"
          />
        </div>
        ...
        {error && (
          <div className="bg-red-100 text-red-700 px-4 py-2 rounded mb-4 text-center animate-pulse">
            {error}
          </div>
        )}
        {weather && (
        ...
        {!weather && !loading && !error && (
          <div className="text-center text-gray-400 mt-8">
            Search for a country to see the weather.
          </div>
        )}
      </div>
